...
# CHANGE 3: Delete the JSON  schemas. Tools now live inside the prompt as palin text.
...
def run_agent(question: str):
    ...
    for iteration in range(1, MAX_ITERATIONS + 1):
        ...
        print(f"  [Parsing] Looking for Action and Action Unput in LLM output...")
        ...
        # Split comma-separated args; skip key= prefix if LLM output key=value format
